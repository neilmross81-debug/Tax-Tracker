      ...
      <header style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', paddingBottom: '1rem', paddingTop: '0.5rem' }}>
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '0.75rem' }}>
          ...
          <h1 style={{
            ...
            TaxTracker <span style={{ fontSize: '0.8rem', letterSpacing: 'normal', fontWeight: 'normal', opacity: 0.6, WebkitTextFillColor: 'initial', color: 'var(--text-main)', verticalAlign: 'middle', marginLeft: '0.2rem' }}>v22.6</span>
          </h1>
        </div>
